...
- [**Creating a web front end for the SmartMatrix parallel printer server**](https://medium.com/machina-speculatrix/creating-a-web-front-end-for-the-smartmatrix-parallel-printer-server-1066253fa497) : Having a hardware device is all very well. But it becomes so much more powerful when you can use it easily, and from anywhere in the house.
